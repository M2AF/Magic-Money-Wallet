...
function buildWallet() {
  return {
    ...
    swapGetTokens:  (req: unknown)          => send('swap:getTokenList', req),
    ...
    // ChainLens profile — the real supabase-sync runs here (it signs an
    // ownership proof and calls the Worker; no key is bundled).
